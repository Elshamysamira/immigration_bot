...
# Step 4: Use Cohere to generate embeddings
embedding_model = CohereEmbeddings(model="embed-multilingual-light-v2.0", cohere_api_key=cohere_api_key)

# Step 5: Store document chunks in ChromaDB
vectorstore = Chroma.from_documents(documents=document_chunks, embedding=embedding_model)

# Step 6: Set up the retriever to retrieve relevant documents
...
# Step 8: RAG pipeline - Retrieval and generation
def rag_pipeline(user_input):
    ...
    # Step 9: Use Cohere to generate a response
